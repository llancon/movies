...
movies.push({title: "Batman Begins",
...
movies.push({title: "Bourne Identity",
...
movies.push({title: "The Count of Monte Cristo",
...
movies.push({title: "Les Misérables",
...
(movies).forEach(function(mov){
  document.getElementById('movie_list').innerHTML = document.getElementById('movie_list').innerHTML + "<td>" + mov.title + "</td>" + "<td>" + mov.director_list + "</td>" + "<td>" + mov.year + "</td>" + "<td>" + mov.actors + "</td>" + "<td>" + mov.imdb_rating + "</td>"
})
